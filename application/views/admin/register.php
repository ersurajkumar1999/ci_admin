            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="post" action="<?php echo base_url('admin/admin_ragistation'); ?>">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="yourUsernumber" class="form-label">Usernumber</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="text" name="number" class="form-control" id="yourUsernumber">
