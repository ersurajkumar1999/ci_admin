                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <form method="post" action="<?php echo base_url().'admin/update_manager/'.$manager['id'];?>">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="email" type="email" class="form-control" value="<?php echo $manager['email']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="password" type="text" class="form-control" id="Job" value="<?php echo $manager['password']; ?>">
                                        </div>
                                    </div>
